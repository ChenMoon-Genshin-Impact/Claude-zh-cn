...
- ✨ **380+ 趣味动词**：从 190 个翻倍到 380+，涵盖修仙、打工、开发、运维全流程
- 📚 **10倍上下文增强**：中文指导从 200 字扩展到 2000 字，Claude 回复更自然
- 🔔 **7倍通知覆盖**：通知翻译从 6 种扩展到 40+ 种，网络、Git、构建错误全覆盖
- 📖 **60+ 错误翻译**：常见错误信息翻译参考增加 6 倍，快速理解问题
- 🎨 **10倍风格优化**：输出风格指导扩展 10 倍，技术术语处理更规范

查看 [CHANGELOG.md](./CHANGELOG.md) 了解详情 | 查看 [IMPROVEMENTS.md](./IMPROVEMENTS.md) 了解改进细节
...
**380+ 趣味 spinner 动词**，41 条中文提示，AI 默认中文回复。**装完即用。**
...
插件每 6 小时检查一次更新，自动同步到最新版本。**无需任何配置，安装即生效。**
...
| 功能 | 说明 |
|------|------|
| 🌐 **AI 中文回复** | 默认使用简体中文回复，技术术语处理更规范 |
| 🎨 **380+ 趣味动词** | `光合作用中`、`七荤八素中`、`蹦迪中`、`炼丹中`、`摸鱼中`... |
| 💬 **41 条中文提示** | 等待提示、快捷键说明等 |
| 🔔 **40+ 通知翻译** | 网络错误、Git 冲突、构建失败等常见通知全覆盖 |
| 📚 **60+ 错误翻译** | 文件系统、网络、HTTP、Git、构建等错误信息参考 |
