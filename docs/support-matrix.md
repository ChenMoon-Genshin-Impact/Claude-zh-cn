...
| macOS native binary | 2.1.113 - 2.1.126 (不含 2.1.115) | experimental | native + 显示审计已验证 | 只用已验证版本 |
...
| macOS native binary | experimental | 2.1.113 - 2.1.126 (不含 2.1.115) | 2.1.113 PASS(native 1358, display 11/11) · 2.1.114 PASS(native 1358, display 11/11) · 2.1.116 PASS(native 1351, display 11/11) · 2.1.117 PASS(native 1334, display 11/11) · 2.1.118 PASS(native 1323, display 11/11) · 2.1.119 PASS(native 1328, display 11/11) · 2.1.120 PASS(native 1331, display 11/11) · 2.1.121 PASS(native 1334, display 11/11) · 2.1.122 PASS(native 1334, display 11/11) · 2.1.123 PASS(native 1334, display 11/11) · 2.1.124 PASS(native extract/version) · 2.1.126 PASS(native extract/version) | macOS arm64 native binary experimental；需要 node-lief；已验证 2.1.113、2.1.114、2.1.116 - 2.1.126 的 extract / patch / repack / --version；2.1.115 官方未发布；不代表未来 latest 自动稳定。 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 2.1.92 | legacy | PASS | - | PASS (11 surfaces) | 1587 | - |
| 2.1.97 | legacy | PASS | - | PASS (11 surfaces) | 1584 | - |
| 2.1.104 | legacy | PASS | - | PASS (11 surfaces) | 1550 | - |
| 2.1.107 | legacy | PASS | - | PASS (11 surfaces) | 1524 | - |
| 2.1.110 | legacy | PASS | - | PASS (11 surfaces) | 1516 | - |
| 2.1.112 | legacy | PASS | - | PASS (11 surfaces) | 1517 | - |
